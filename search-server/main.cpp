...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, FunctionPredicate function_predicate) const {
...
private:
    ...
    template <typename FunctionPredicate>
    vector<Document> FindAllDocuments(const Query& query, FunctionPredicate function_predicate) const {
        ...
        for (const string& word : query.plus_words) {
            ...
            for (const auto [document_id, term_freq] : word_to_document_freqs_.at(word)) {
                ...
                if (function_predicate(document_id, document_data.status, document_data.rating)) {
